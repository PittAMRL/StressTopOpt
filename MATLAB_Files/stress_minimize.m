function [f0val,df0dx,fval,dfdx]=stress_minimize(x,Hs,H,nelx,nely,nelz)
...
figure(2)
MISES_plot=reshape(MISES.*(0.5*sign(x-0.5)+0.5),nely,nelx,nelz);
imagesc(MISES_plot(:,:,1));axis equal;axis off; colormap('jet');title('Von-Mises Stress');colorbar;drawnow;
